...
ImageSequenceProviderDescriptor ImageSequenceProviderAdapter::descriptor() const
{
    ImageSequenceProviderDescriptor descriptor;
    descriptor.setSessionFactory(sessionFactory());
    descriptor.setKnownMetadata(knownMetadata());
    descriptor.setKnownFacts(knownFacts());
    descriptor.setTimedPlaybackCapability(timedPlaybackCapability());
    descriptor.setFrameSeekCapability(frameSeekCapability());
    descriptor.setPositionSeekCapability(positionSeekCapability());
    descriptor.setAuthoredAnimationFacts(authoredAnimationFacts());
    descriptor.setThreadingContract(threadingContract());
    return descriptor;
}
