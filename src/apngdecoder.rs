...
#[cfg(test)]
use parser::{BlendOp, DisposeOp, PNG_SIGNATURE, append_png_chunk, crc32, read_png_chunk};
#[cfg(test)]
use png::{BitDepth, ColorType};
#[cfg(test)]
use render::{Rect, blend_frame, clear_region, copy_region, premultiply_rgba, restore_region};
