...
ImageViewport::TriState ImageViewport::timedPlaybackSupport() const { return d->timedPlaybackSupport(); }
ImageViewport::TriState ImageViewport::frameSeekSupport() const { return d->frameSeekSupport(); }
ImageViewport::TriState ImageViewport::positionSeekSupport() const { return d->positionSeekSupport(); }
...
ImageViewport::HorizontalAlignment ImageViewport::horizontalAlignment() const { return d->horizontalAlignment(); }
void ImageViewport::setHorizontalAlignment(HorizontalAlignment alignment) { d->setHorizontalAlignment(alignment); }
ImageViewport::VerticalAlignment ImageViewport::verticalAlignment() const { return d->verticalAlignment(); }
void ImageViewport::setVerticalAlignment(VerticalAlignment alignment) { d->setVerticalAlignment(alignment); }
...
ImageViewport::CommandOutcome ImageViewport::seekToPosition(int milliseconds) { return d->seekToPosition(milliseconds); }
...
bool ImageViewport::containsVisibleImagePoint(double x, double y) const { return d->containsVisibleImagePoint(x, y); }
...
{
    const QRectF oldContentRect = d->contentRect();
    const QRectF oldVisibleImageRect = d->visibleImageRect();
