...
namespace kiriview {
uint qHash(TileKey key, uint seed)
{
...
bool TilePyramid::containsTile(TileKey key) const
{
...
std::vector<TileKey> TilePyramid::tilesIntersectingLevelRect(int level, QRect levelRect) const
{
