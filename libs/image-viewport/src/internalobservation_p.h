...
enum class InternalObservationCause {
    ...
    ProviderProtocolTokenMismatch,
    ProviderProtocolRoleMismatch,
    ProviderProtocolGenerationMismatch,
    ProviderProtocolEventKindMismatch,
    ProviderProtocolEventShapeMismatch,
