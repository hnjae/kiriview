...
This directory contains KiriView's project documentation. Keep user-visible behavior, architecture direction, research notes, and packaging notes in the narrowest document set that owns the topic.
...
- [Research](research/README.md): dated upstream and technical investigation notes that inform later design or implementation work.
