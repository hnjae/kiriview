...
Architecture contract files remain the normative source for the intended end-state design. ADRs preserve rationale and consequences; they must not be used as deferred-work lists or implementation-status indexes.
