...
constexpr std::array actionDefinitions {
    ...
    registeredAction(Actions::ActionId::GoLastImageAction, "go_last_image", Category::Navigation,
        ...
        shortcutRouteSpecs(route(ActivationScope::ViewerLocal, Scope::PageViewerShortcutScope))),
    standardAction(Actions::ActionId::ViewZoomAction, "view_zoom", Category::View,
        KStandardActions::Zoom, kli18nc("@action", "Zoom..."), portableShortcutSpec("Ctrl+Y"),
        noDefaultShortcuts(),
        shortcutRouteSpecs(route(ActivationScope::ProgramWide, Scope::ReadyShortcutScope))),
