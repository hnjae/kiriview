...
public:
    ...
    [[nodiscard]] DocumentKind documentKind() const;
    ...
    [[nodiscard]] KiriMediaInformation* mediaInformation() const;
    [[nodiscard]] const kiriview::MediaInformationProjectionSnapshot&
    mediaInformationSnapshot() const;
    [[nodiscard]] const kiriview::DocumentSessionActionStateSnapshot& actionStateSnapshot() const;
    kiriview::DocumentSessionActionStateSnapshotPort actionStateSnapshotPort();
    [[nodiscard]] const kiriview::DocumentSessionActionAvailabilityFacts&
    actionAvailabilityFacts() const;
