...
- The concrete numeric values for the named source and display limits require representative image workloads and Qt/backend measurements before they can be fixed responsibly.
