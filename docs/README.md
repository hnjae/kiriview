...
This directory contains KiriView's project documentation. Keep user-visible behavior, architecture direction, milestone planning, and packaging notes in the narrowest document set that owns the topic.
