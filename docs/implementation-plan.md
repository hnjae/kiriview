...
- Thumbnail panel scroll math currently lives in QML; QML coverage stays at representative visible workflows until that behavior has a lower-level production policy boundary.
- Pixel-level toolbar geometry assertions are visual implementation details unless tied to a declared user workflow or accessibility contract.
