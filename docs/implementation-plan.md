...
Verification for this slice: `cmake --build build-ninja` passed, and focused `ctest --test-dir build-ninja -R 'imageviewport_public_api$|imageviewport_public_api_qml|imageviewport_presentation_state|imageviewport_still|viewportcontroller_presentation' --output-on-failure` passed 5/5.
