...
Image page-resource owners schedule refinement through an injected worker scheduler. Work carries separate reuse and active-demand identities; a completion may populate a compatible bounded cache by reuse identity but may publish only after the owner accepts the full active-demand identity. In-flight sharing and worker start gates are best-effort cancellation tools, not alternate publication authority.
